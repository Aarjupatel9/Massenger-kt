...
class PageViewModel() : ViewModel() {
	...
	private val mText = Transformations.map<Int, RecyclerViewAdapter>(mIndex, Function<Int, RecyclerViewAdapter?> { input ->
		...
		if (MainActivity.contactArrayList == null) {
			...
			MainActivity.recyclerViewAdapter = RecyclerViewAdapter(MainActivity.MainActivityStaticContext)
		} else {
			MainActivity.MainContactListHolder = ContactListHolder(MainActivity.db)
			MainActivity.contactArrayList = MainActivity!!.contactList

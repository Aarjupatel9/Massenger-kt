...
class LoginActivity : Activity() {
    ...
    private fun registerRedirect() {
        ...
        val newLayout =
            LayoutInflater.from(this).inflate(R.layout.activity_login_page_register, null)
    ...
    private fun checkHaveToRegister(user_number: String, user_password: String) {
        ...
        val request: StringRequest =
            object : StringRequest(Method.POST, endpoint, object : Response.Listener<String?> {
                @SuppressLint("ResourceAsColor")
                        ...
                        when (status) {
                            "1" -> {
                                ...
                                try {
                                    ...
                                    ProfileImageVersion =
                                        respObj.getString("ProfileImageVersion").toString().toLong()
                                    profileImageBase64 = respObj.getString("ProfileImage") as String
                                    val profileImageByteArray =
                                    ...
                                    Log.d(
                                        "log-LoginActivity ",
                                        "expected image not found at login time : $e"
                                    )
                                }
    ...
    fun login(
        ...
        Log.d(
            "log-reached",
            "before db initialize : " + login_details.MobileNumber + " qnd " + login_details.Password
        )
